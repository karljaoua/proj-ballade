...
// Appeler la fonction insertList en lui passant les infos du formulaire
// Récupérer le nouvel id de la balade créé
// insertList($id, $titre, $pseudo, $type, $codepostal, $ville, $pays, $lieudepart, $lieuarrivee ,$description, $etapes ,$photo)

$nouvelId = $database->updateListe($id, $titre, $pseudo, $type, $codepostal, $ville, 
